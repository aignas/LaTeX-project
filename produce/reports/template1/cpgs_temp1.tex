...
\documentclass[a4paper,12pt]{report} %report
...
% Everything for setting up the headers
\usepackage{fancyhdr}
\pagestyle{fancy}
...
% Set space package lets to control line spacing
\usepackage{setspace} 
% more on options visit https://secure.wikimedia.org/wikibooks/en/wiki/LaTeX/Customizing_LaTeX#Spacing
\doublespacing
...
\fancyhead[RE, LO]{Eric Andrew Appel \\ \leftmark}
