...
%
A much better approach is to use a much more powerful \env{align} environment,
    which is provided by the \pkg{amsmath} package.
%
\input{eg-mmath2.tex}
%
...
For chemical reactions and other symbols typesetting I suggest you using the
    \pkg{mhchem} package which should already be bundled with your \TeX{}
    distribution.
%
...
For more capabilities of the package it would be possibly best to flick through
    ...
    \uurl{http://mirrors.ctan.org/macros/latex/contrib/mhchem/mhchem.pdf}{this
    link}.
