...
There is also achemso package
    ...
    \uurl{http://www.ctan.org/tex-archive/macros/latex/contrib/achemso}{CTAN
    package directory}.
%
...
\todo{Write about AIP and APS journals}
\todo{Include a simple template into a repository.}
...
You \emph{should} create more folders for any additional chapter and read
    through the notes in the master \ftype{tex} file called \fname{head}{tex}.

%
There is also an additional \fname{stats}{tex} file for getting the statistics
    from your thesis or report.
%
It scans the \fname{head}{tex} file and composes a simple document automatically
